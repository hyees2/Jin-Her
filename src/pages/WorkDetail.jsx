...
////_Unseen
import coverMain1_Unseen from '../assets/images/Unseen/cover_Unseen.jpg';
import coverMain11_Unseen from '../assets/images/Unseen/cover2_Unseen.jpg';
    ...
    <div className="more-works-wrapper">
      ...
      <div className="more-works-grid">
        {otherWorks.map((work, index) => (
          <a key={index} href={`/Jin-Her/work/${work.id}`} className="more-works-item">
            <div className="more-works-image-wrapper">
              <img
                src={work.cover}   // ✅ 대표 이미지로 고정
                alt={work.title}
                className="more-works-image"
              />
              <div className="more-works-overlay"></div>
            </div>
          </a>
        ))}
      </div>
...
const workData = [
  {
    ...
    year: '2024',
    cover: coverMain1_Petrichor,   // ✅ 썸네일용 대표 이미지 추가
    fullDescription: 'Petrichor is a brand ...',
  ...
  },
  {
    ...
    year: '2025',
    cover: coverMain1_Unseen,   // ✅
    fullDescription: 'This project does not view ...',
    credits: { type: 'Personal Project', client: null, design: null },
    images: [
      { src: coverMain11_Unseen, isLarge: true },
  ...
  },
  {
    ...
    year: '2024',
    cover: coverMain1_Sunset,   // ✅
    fullDescription: 'We developed accompanying visuals ...',
  ...
  },
  {
    ...
    year: '2023',
    cover: coverMain1_OPBU,   // ✅
    fullDescription: 'OPBU is an imaginary ...',
    credits: { type: 'Personal Project', client: null, design: null },
    images: [
  ...
  },
  {
    ...
    year: '2023',
    cover: coverMain1_Twoscapes,   // ✅
    fullDescription: 'This convenience disconnects us ...',
    credits: { type: 'Personal Project', client: null, design: null },
    images: [
